...
Была создана страница lw10.html, на которой были выполнены три анимации с использованием SVG. Также была применена SVG-маска. Проект был выложен на github и beget. На github почему-то выдаёт страницу 404 другую
